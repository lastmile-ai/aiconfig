...
If that doesn't work, you can also try less computationally intensive models. 
        ...
        refined_responses = _refine_responses(response.images or [], has_nsfw_responses)
...
def _refine_responses(
    ...
    Args:
        ...
        has_nsfw_responses List[bool]: List of whether the image at that 
    ...
    merged_responses : List[Tuple[Image.Image, bool]] = list(
        # Use zip.longest because has_nsfw_responses can be empty
        itertools.zip_longest(response_images, has_nsfw_responses)
    )
