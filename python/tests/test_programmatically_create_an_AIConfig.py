...
def test_get_override_settings_based_on_global_settings(ai_config_runtime: AIConfigRuntime):
    settings = {"topP": 0.9}
    override = ai_config_runtime.extract_override_settings(settings, "testmodel")
