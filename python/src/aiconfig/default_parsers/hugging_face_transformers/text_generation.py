...
def construct_regular_output(result: Dict[str, str], response_includes_details: bool) -> Output:
    """
...
class HuggingFaceTextGenerationTransformer(ParameterizedModelParser):
    ...
    async def run_inference(
        ...
        for result in response:
            output = construct_regular_output(result, response_includes_details=False)
