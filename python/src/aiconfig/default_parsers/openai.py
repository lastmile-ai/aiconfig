...
class OpenAIInference(ParameterizedModelParser):
    ...
    async def run_inference(self, prompt: Prompt, aiconfig: "AIConfigRuntime", options, parameters) -> Output:
        ...
        """
        aiconfig.callback_manager.run_callbacks(CallbackEvent("on_run_start", {"input": locals()}))
        ...
        aiconfig.callback_manager.run_callbacks(CallbackEvent("on_run_complete", {"output": prompt.outputs}))
