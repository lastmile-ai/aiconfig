...
class OpenAIInference(ParameterizedModelParser):
    ...
    def serialize(
        ...
        **kwargs,
        ...
        """
        event = CallbackEvent("on_serialize_start", {})
        ...
        event = CallbackEvent("on_serialize_complete", {})
        ai_config.callback_manager.run_callbacks(event)
        return prompts
    ...
    async def deserialize(
        ...
        """
        aiconfig.callback_manager.run_callbacks(CallbackEvent("on_deserialize_start", {}))
        ...
        aiconfig.callback_manager.run_callbacks(CallbackEvent("on_deserialize_complete", {}))
    ...
    async def run_inference(self, prompt: Prompt, aiconfig: "AIConfigRuntime", options, parameters) -> Output:
        ...
        """
        aiconfig.callback_manager.run_callbacks(CallbackEvent("on_run_start", {}))
        ...
        aiconfig.callback_manager.run_callbacks(CallbackEvent("on_run_complete", {}))
