...
export const HuggingFaceAutomaticSpeechRecognitionRemoteInferencePromptSchema: PromptSchema = {
  ...
  // The settings below are supported settings specified in the HuggingFaceImage2AutomaticSpeechRecognitionRemoteInference refine_completion_params implementation.
  input: {
    type: "object",
