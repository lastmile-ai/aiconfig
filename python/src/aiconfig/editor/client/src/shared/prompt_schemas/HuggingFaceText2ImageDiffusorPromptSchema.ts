...
export const HuggingFaceText2ImageDiffusorPromptSchema: PromptSchema = {
  ...
  // The following supported properties cannot be cleanly modeled in the schema and must be implemented programmatically:
  // generator, latents, prompt_embeds, negative_prompt_embeds
