...
def text_eval_res_to_df(
    eval_res: DatasetEvaluationResult[
        common.TextBasedInputDatum, common.TextOutput
    ],
) -> pd.DataFrame:
    def _extract_text_based_input_for_display(
        ...
        def _extract_value(
            input_text_datum: common.TextBasedInputDatum | None,
        ) -> str | None:
...
async def user_test_suite_with_inputs_to_eval_params_list(
    ...
    DatasetEvaluationParams[common.TextBasedInputDatum, common.TextOutput], str
]:
    """
    Example in/out:
    ...
    input_to_metrics_mapping: dict[
        common.TextBasedInputDatum, MetricList[common.TextOutput]
    ] = {}
    ...
    res_outputs = await common.batch_run_aiconfig_on_text_based_input(
        aiconfig, prompt_name, all_inputs
    )
...
def user_test_suite_outputs_only_to_eval_params_list(
    ...
    return [
        SampleEvaluationParams(
            input_sample=None,
            output_sample=common.TextOutput(output_datum),
            metric=metric,
        )
...
async def run_test_suite_helper(
    ...
    DatasetEvaluationResult[common.TextBasedInputDatum, common.TextOutput], str
]:
    ...
    async def _evaluate_with_timeout(
        ...
        DatasetEvaluationResult[common.TextBasedInputDatum, common.TextOutput],
        str,
    ]:
