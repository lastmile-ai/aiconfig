...
class CallbackEvent:
    """
    Data class that represents an event that triggers a callback.
    Backed by a pydantic model for easy serialization.
    """
...
# Type declaration for Asyn function
...
class CallbackManager:
    def __init__(self, callbacks: Sequence[Callback], timeout: Optional[int] = 5) -> None:
