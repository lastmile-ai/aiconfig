...
This will open AIConfig Editor in your default browser and create a new AIConfig JSON file `travel.aiconfig.json` in your current directory.
...
A new tab with the AIConfig Editor opens in your default browser with the prompts, chaining logic, and settings from `updated_travel.aiconfig.json`. Your edits will auto-save every 15 seconds. You can also manually save with the Save button.
...
Join our Discord community [here](https://discord.com/invite/xBhNKTetGx)!
