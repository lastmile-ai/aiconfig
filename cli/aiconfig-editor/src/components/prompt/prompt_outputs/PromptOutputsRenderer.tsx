...
import { ClientExecuteResult, ClientPromptOutput } from "@/src/shared/types";
import { memo } from "react";
import { TextRenderer } from "@/src/components/prompt/TextRenderer";
...
const ExecuteResultOutput = memo(function ExecuteResultOutput({
  ...
  switch (output.client.type) {
    case "text":
      return <TextRenderer content={output.client.text} />;
